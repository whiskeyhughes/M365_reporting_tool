...
st.image(
    flaccid_logo, width=450, caption="Focusing on Hardening your Office 365 Environment"
)
...
def defineVariables():
    ...
    security_weight_ranking = {
        ...
        5: ["Microsoft 365 Enterprise E3 + (E5 Sec)", "Microsoft 365 Enterprise E5"],
    }
    ...
    if security_weight_total == 1:
        st.sidebar.write("🍆")
        st.sidebar.caption(
            "That is one of the smallest Security Eggplants we have ever seen..."
        )
